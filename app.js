...
function renderAbout() {
  app.innerHTML = `<section class="about-page"><span class="eyebrow">ABOUT CLOSKILL</span><h1>CloSkillについて</h1><p class="about-lead">CloSkillは、学びたい人が自分のペースでスキルを身につけられる動画学習サービスです。</p><div class="about-grid"><article class="about-card"><span class="about-card-icon">▶</span><h2>いつでも学べる</h2><p class="muted">購入した講座の動画を、好きな時間に何度でも視聴できます。</p></article><article class="about-card"><span class="about-card-icon">✦</span><h2>実践的な講座</h2><p class="muted">HTML/CSS、JavaScript(jQuery)、WordPressなど、Web制作に役立つ講座を用意しています。</p></article><article class="about-card"><span class="about-card-icon">✓</span><h2>あなたの学習ページ</h2><p class="muted">マイページから購入済みの講座をすぐに確認し、続きから学習できます。</p></article></div><div class="about-section"><span class="eyebrow">HOW TO USE</span><h2>CloSkillの使い方</h2><div class="usage-steps"><article class="usage-step"><span>01</span><div><h3>アカウントを作成</h3><p class="muted">新規登録からアカウントを作成し、ログインします。</p></div></article><article class="usage-step"><span>02</span><div><h3>講座を選んで購入</h3><p class="muted">講座一覧から学びたいコースを選び、購入手続きを行います。</p></div></article><article class="usage-step"><span>03</span><div><h3>マイページで学習</h3><p class="muted">購入した講座はマイページからいつでも視聴できます。</p></div></article></div></div><div class="about-section developer-section"><span class="eyebrow">DEVELOPER</span><h2>開発者紹介</h2><div class="developer-card"><div class="developer-avatar">Y</div><div><h3>Y-programing</h3><p class="muted">学ぶ人が一歩ずつ成長できる場所を目指して、CloSkillを開発しています。Web制作を身につけたい方に、分かりやすく実践的な学習体験を届けます。</p></div></div></div><a class="button button-primary" href="#/courses">講座一覧を見る</a></section>`;
}
